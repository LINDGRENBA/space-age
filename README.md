...
|  Program will calculate user's average life expectancy on each planet, rounded up to the nearest whole number, based on their average life expectency on Earth  |  life expectency on Earth = 85  |  Mercury = 352, Venus = 138, Mars = 45, Jupiter = 7  |  N  |
