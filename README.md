...
| Steps | Example |
| -------- | ----- |
| Follow this [link to the project repository](https://github.com/LINDGRENBA/space-age) on GitHub.   |    |    
...
|  Once you have cloned or downloaded the project and opened it in VS Code, open a new terminal by navigating to Terminal -> New Terminal. A terminal will open on the page.  | ![Opening a terminal in VS Code](img/readme/terminal.PNG)  |
...
| -------- | ----- | ------ | -------- |
|  Program will create a user object that holds user name age  |  n/a  |  user {name: 'Cheryl', age: '33'}  |  N  |
